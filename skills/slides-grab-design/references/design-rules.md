...
## Slide spec
- Slide size: `720pt x 405pt` (16:9) using Tailwind: `w-[720pt] h-[405pt]`
- Font: Pretendard (`font-['Pretendard']`)
- Requires Tailwind Play CDN: `<script src="https://cdn.tailwindcss.com"></script>`
- Semantic text tags only: `p`, `h1-h6`, `ul`, `ol`, `li`
- Use Tailwind utility classes for colors and layouts.
...
- Use **Tailwind utility classes** for all styling instead of inline CSS properties.
